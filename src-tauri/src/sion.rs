...
use crate::{blocker, blocklist::BlockList, host_request};

const PROGRAM_NAME: &str = "friendstudy";
    ...
    match args[0].as_str() {
        ...
        "-s" => {
            ...
            Command::new("osascript")
                .arg("-e")
                .arg(format!("do shell script \"./target/debug/{PROGRAM_NAME} -w {time}\" with administrator privileges"))
                .spawn()
